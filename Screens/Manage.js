...
// : console.log("no params" , myId );
    ...
    return (     
      item.directUserId == this.state.userId  ||  item.directUserId == 0 ?
          <View style={{backgroundColor: item.directUserId == this.state.userId ? "#d9feff" : "#fff",
          elevation: 7,
          borderRadius: 10,
          width: widthPercentageToDP("90%"),
          alignSelf:"center",
        ...
        <Provider>
          <View style={styles.container}>
            ...
            >
              ...
              {this.props.route.params.projectType == "ONLINE" ? (
                <>
                <View style={{alignSelf:"center",width:"100%", flexDirection:"row",marginHorizontal:16}}>
                <View style={{width:"90%",marginTop: 16,marginLeft:"5%",marginRight:"5%"}}>
                    <TextInput
                ...
                //   <View style={{ alignSelf: "center",width:"100%",flexDirection:"row" }}>
                  ...
                  <View style={{ flexDirection: "row", width: "100%" }}>
                    ...
                    >
                      <TextInput
                        onChangeText={(text) => this.searchProjects(text)}
                        allowFontScaling={false}
                        placeholder="Search Projects...1"
                        style={[styles.txtipt, { marginTop: 16, width: widthPercentageToDP(80)}]}
                      />
                      <Feather
                        name="search"
                        size={24}
