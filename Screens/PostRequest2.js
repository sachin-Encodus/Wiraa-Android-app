...
export default class PostRequest extends React.Component{
    ...
    this.state = {
            ...
            budget:"",
            budgetType:"",
            postid: this.props.route.params !== undefined ? this.props.route.params.fkUserProfileId : 0,
            // this.props.route.params ? this.props.route.params.categoryName :
...
// const myuserID = this.props.route.params !== undefined ? this.props.route.params.fkUserProfileId : 0;
// if(myuserID !==  0){
// console.log("123xxxx",myuserID);
// }else{
//   console.log("123xxxx no");  
// }
console.log("postid",this.state.postid);
    ...
    postRequest = async() => {
        ...
        // console.log(this.state.budgetType);
        // {
        //     ""postreqID"": 0,
        //     ""pR_Description"": ""hh"",
        //     ""pR_FKCatID"": 0,
        //     ""pR_FKSubCategoryID"": 0,
        //     ""expertise"": ""Accounting,Banking Industry,Bookkeeping"",
        //     ""serviceMode"": ""Face-2-Face"",
        //     ""city"": ""Ujjain India"",
        //     ""serviceStartDate"": ""2020-12-04"",
        //     ""budget"": 10,
        //     ""workType"": ""Per hour"",
        //     ""postStatus"": ""Active"",
        //     ""postExpireDate"": ""11/12/2020 19:20:35"",
        //     ""postValidity"": 7,
        //     ""validityStatus"": false,
        //     ""userid"": 10191,
        //     ""applyDate"": ""4/12/2020 19:20:35"",
        //     ""preferService"": ""As Soon As Possible"", 
        //     ""directUserId"": 0
        //     }
        ...
        try{   
            ...
            var data ={
                ...
                "validityStatus": false,
                "userid": userId,
                "serviceStartDate": this.state.day+"/"+this.state.month+"/"+this.state.year,
                "applyDate": day+"/"+month+"/"+year,
                "preferService": this.state.selectedImd === true ? "As soon as possible" : "",
                "directUserId": this.state.postid
            }
    ...
    render(){
        // console.log("props request page ---==>>",this.props)
        ...
        return(
            ...
            <View style={styles.container}>
                ...
                <ScrollView nestedScrollEnabled={true} showsVerticalScrollIndicator={false}>
                    ...
                    <Text allowFontScaling={false} style={styles.label}>Describe the service you are looking for..</Text>
                    ...
                    <View style={{alignSelf:"stretch", backgroundColor:"#efefef", marginTop:10, borderRadius:6,elevation:2,marginHorizontal:"1%"}}>
                        <Picker
                            ...
                            style={{height: 50}}
                            onValueChange={(itemValue, itemIndex) => { this.setState({valueOfCat:itemValue}),this.state.cirId !== null ? this.getSubCategory(this.state.cirId) : this.getSubCategory(itemValue) } }
                        >
                            <Picker.Item label={this.state.catText} />
                    ...
                    <Text allowFontScaling={false} style={styles.label}>Choose a Sub Category:</Text>
                    ...
                    <View style={{alignSelf:"stretch", backgroundColor:"#efefef", marginTop:10, borderRadius:6,elevation:2,marginHorizontal:"1%"}}>
                        <Picker
                            ...
                            style={{height: 50}}
                            onValueChange={(itemValue, itemIndex) =>{this.setState({valueOfSubcat:itemValue}),this.state.gradeId !== null ? this.getSpeciality(this.state.gradeId) : this.getSpeciality(itemValue) } }
                        >
                            <Picker.Item label={this.state.subCatText} />
                    ...
                    <View style={{height:200, display: this.state.subCatText === "Select Sub Category" ? "none" : "flex" }}> 
                        ...
                        <ScrollView nestedScrollEnabled={true} contentContainerStyle={{ paddingTop:6, flexDirection:"row", flexWrap:"wrap", justifyContent:"flex-start", }}>
                    ...
                    <Text allowFontScaling={false} style={styles.label}>Choose your mode of service:</Text>
                    ...
                    <Text allowFontScaling={false} style={styles.label}>Preferred service starting date:</Text>
                    ...
                    <Text allowFontScaling={false} style={styles.label}>Preferred Project Budget:</Text>
                    <View style={{marginHorizontal:"1%"}}>
                    <TextInput selectionColor="#efefef" underlineColor="#efefef" style={[styles.txtipt, {height:50, marginTop:10,elevation:2,backgroundColor:"#efefef"}]} onChangeText={(text) => this.setState({budget: text})} placeholder="₹" />
                    </View>
                    {
                        this.state.budget  === "" ?
